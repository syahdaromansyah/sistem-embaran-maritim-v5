          ...
          <div className="mb-20 md:flex md:items-start md:justify-between">
            ...
            <section className="mb-10 md:mb-0 md:flex-1">
              ...
              <p>
                ...
                veniam nostrum aliquid culpa iure esse, reprehenderit laborum
                aspernatur dignissimos unde, voluptas laboriosam earum. Alias
                dolore odio corporis incidunt nobis cupiditate obcaecati
                recusandae aperiam voluptatem itaque, debitis, enim temporibus.
                Assumenda illum harum quibusdam.
              </p>
            </section>
          </div>
